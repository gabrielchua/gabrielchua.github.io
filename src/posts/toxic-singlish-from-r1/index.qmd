...
author: "Gabriel Chua"
date: "2025-01-23"
categories: [red-teaming, responsible-ai]
---
...
![Created with emojimix by Tikolu](image.png)
...
1. **Clear instructions** for handling ambiguity (e.g., how to distinguish hate speech from general insults).
2. **Text delimiters** (e.g., XML tags) to separate instructions from content or examples.
3. **Examples of harmful phrases** — not all strictly Singlish — to illustrate the style and content we sought.
...
![Created with emojimix by Tikolu](angry-whale.png.png)
...
![Created with emojimix by Tikolu](safe-whale.png.png)
...
![Created with emojimix by Tikolu](specs-whale.png.png)
