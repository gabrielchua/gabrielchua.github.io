...
Last weekend, I found myself with over $300 in expiring OpenAI API credits and decided to dive headfirst into generating synthetic data with GPT-4o. The result? A dataset of over 2 million examples, featuring both system and user prompts, which you can check out here: [synthetic dataset](https://huggingface.co/datasets/gabrielchua/off-topic).
